...
import type { DELIVERY_METHODS, ORDER_STATUS, PAYMENT_METHODS, PAYMENT_STATUS } from './order.constants';
...
export type TDeliveryMethod = (typeof DELIVERY_METHODS)[keyof typeof DELIVERY_METHODS];
